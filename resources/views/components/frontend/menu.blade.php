			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="{{ route('cart') }}">
							<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" id="cart" data-notify="{{ session('cart')['total_quantity'] ?? 0 }}">
...
@push('js')
	<script>
		Livewire.on('cartCount',data => {
			console.log(data);
			document.querySelector('#cart').dataset.notify = data;
		});
	</script>
@endpush